...
#remember, single is just the name we are giving it, and it relates to the function single in views. The address the user is entering is phenomena/5 (or another number that is an event id)
